            ...
            <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto min-h-0 scrollbar-thin">
                ...
                <div class="pt-4">
                    ...
                    <div class="mt-2 space-y-1">
                        ...
                        <NavLink :href="route('stock-movements.index')" :active="route().current('stock-movements.*')">
                            <template #icon>
                                <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="pt-4">
                    ...
                    <div class="mt-2 space-y-1">
                        ...
                        <NavLink :href="route('sales.index')" :active="route().current('sales.index') || route().current('sales.show')">
                            <template #icon>
                                <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="pt-4">
                    ...
                    <div class="mt-2 space-y-1">
                        ...
                        <NavLink :href="route('goods-received-notes.index')" :active="route().current('goods-received-notes.*')">
                            <template #icon>
                                <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="pt-4">
                    ...
                    <div class="mt-2 space-y-1">
                        <NavLink :href="route('reports.sales')" :active="route().current('reports.sales')">
                            <template #icon>
                                <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <NavLink :href="route('reports.procurement')" :active="route().current('reports.procurement')">
                            <template #icon>
                                <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div v-if="$page.props.auth.user?.role?.name === 'Super Admin'" class="pt-4">
                    ...
                    <div class="mt-2 space-y-1">
                        ...
                        <NavLink :href="route('admin.branches.index')" :active="route().current('admin.branches.*')">
                            <template #icon>
                                <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <NavLink :href="route('admin.system-config.index')" :active="route().current('admin.system-config.*')">
                            <template #icon>
                                <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
// Switch branch by updating the URL with branch_id query parameter
const switchBranch = (branchId) => {
    ...
    // Navigate to the same page with the new branch filter
