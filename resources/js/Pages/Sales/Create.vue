                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex justify-between text-sm">
                            ...
                            <input
                                ...
                                :max="subtotal"
                                step="0.01"
                                class="w-24 text-right rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 text-sm"
                            />
                        </div>
                        <!-- VAT Display -->
...
const total = computed(() => {
    return Math.max(0, subtotal.value - (parseFloat(form.discount_amount) || 0) + vatAmount.value);
});
